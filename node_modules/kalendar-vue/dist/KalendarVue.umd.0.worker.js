...
/******/ 	return __webpack_require__(__webpack_require__.s = "6c0e");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./src/components/kalendar/workers/operations.worker.js
...
var operations_worker_generateUUID = utils.generateUUID,
    operations_worker_addDays = utils.addDays,
    operations_worker_addMinutes = utils.addMinutes,
    operations_worker_addHours = utils.addHours,
    operations_worker_getYearMonthDay = utils.getYearMonthDay,
    operations_worker_getLocaleTime = utils.getLocaleTime;
...
register_default()(function (message) {
  ...
  switch (type) {
    ...
    case 'getDayCells':
      return operations_worker_getDayCells(data.day, data.hourOptions);
...
function getDays(dayString, _ref) {
  ...
  if (view_type === 'day') {
    ...
    for (var idx = 0; idx < 7; idx++) {
      days.push({
        value: operations_worker_addDays(date, idx - day_of_week).toISOString(),
        index: idx
      });
    }
  }
...
function getHours(day_options) {
  ...
  var iso_date = operations_worker_getYearMonthDay(date);
...
var operations_worker_getDayCells = function getDayCells(dayString, day_options) {
...
var constructDayEvents = function constructDayEvents(day, existing_events) {
  var events_for_this_day = existing_events.map(function (event) {
    var from = event.from,
        to = event.to;
    from = operations_worker_getLocaleTime(from);
    to = operations_worker_getLocaleTime(to);
...
var constructNewEvent = function constructNewEvent(event) {
  ...
  var constructedEvent = {
    ...
    data: event.data,
    id: event.id || operations_worker_generateUUID(),
...
/******/ });
//# sourceMappingURL=KalendarVue.umd.0.worker.js.map